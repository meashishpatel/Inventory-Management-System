...
class IMS: 
    def __init__(self, root):
        ...
        self.root.title("Inventory Management System | Developed by Ashish Patel, Anjali Upadhyay, Abhijit Tiwari")
        ...
        btn_exit = Button(LeftMenu, text="Exit", font=("times new roman", 20, "bold"), bg="white", bd=3, cursor="hand2",command=self.exit_program).pack(side=TOP, fill=X)
        ...
        #==footer===
        lbl_footer = Label(self.root, text="IMS- Inventory Management System | Developed by Ashish, Anjali, Abhijit\n For any Technical Issue Contact: 7677816141", font=("times new roman", 12), bg="#4d636d", fg="white").pack(side=BOTTOM, fill=X)
        self.update_content()
