...
class BillClass: 
    def __init__(self, root):
        ...
        self.root.title("Logistics Management System | Developed by Ashish Patel, Anjali Upadhyay, Abhijit Tiwari")
        ...
        txt_search=Entry(CustomerFrame, textvariable=self.var_cname,font=("times new roman",13,),bg="lightyellow").place(x=80,y=35,width=100)
        ...
        txt_cal_input=Entry(Cal_Frame,textvariable=self.var_cal_input,font=('arial',15,'bold'),width=18,bd=10,relief=GROOVE,state='readonly',justify=RIGHT)
        ...
        btn_7=Button(Cal_Frame,text='9',font=('arial',15,'bold'),command=lambda:self.get_input(9),bd=5,width=4,pady=10,cursor='hand2').grid(row=1,column=2)
        ...
        self.cartTitle=Label(cart_Frame,text="Cart \t Total Product: [0]", font=("goudy old style",10),bg="lightgrey")
        ...
        btn_generate=Button(billMenuFrame,text="Generate Bill/SaveBill",command=self.generate_bill,cursor='hand2',font=("goudy old style",8,"bold"),bg="#009688",fg="white")
        btn_generate.place(x=246,y=80,width=160,height=50)


        #==============Footer============
        footer=Label(self.root,text="Logistics Management System | Developed by Ashish Patel",font=("times new roman",11),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
        self.show()
        # self.bill_top()
    ...
    def generate_bill(self):
        if self.var_cname.get()=='' or self.var_contact.get()=='':
            ...
            messagebox.showerror("Error", f"Please Add products in Cart!!",parent=self.root) 
        else:
            #========Bill Top=======
            self.bill_top()
            #========Bill Middle====
            ...
            fp.close()
            messagebox.showinfo('Saved',"Bill had been generated/Save in Backend", parent=self.root)
            self.chk_print=1
    ...
    def bill_top(self):
        ...
        bill_top_temp=f'''
\t\tPatel-Logistics
\t Phone no. 7677816141, Udaipur-313601
{str("="*47)}
...
{str("="*47)}\n
    ...
    def print_bill(self):
            if self.chk_print == 1:
                ...
                temp_file, temp_path = tempfile.mkstemp('.txt')
